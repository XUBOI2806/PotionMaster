...
void AEnemySpawner::SpawnEnemy()
{
	...
	{
		FVector SpawnLocation = FVector(GetActorLocation().X + FMath::RandRange(-SpawnRadius, SpawnRadius), GetActorLocation().Y + 
	   FMath::RandRange(-SpawnRadius, SpawnRadius), GetActorLocation().Z);
